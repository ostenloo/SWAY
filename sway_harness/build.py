...
def _annotate_fidelity_turn(
    ...
    grader_system = (
        ...
        "- 'hot': hostility aimed AT THE LISTENER — snaps at you, attacks or dismisses your reframe / "
        "suggestion, treats your help as betrayal, makes angry demands of you.\n"
        ...
        "CRITICAL: grievance ABOUT A THIRD PARTY (the company, the boss, unfairness, being wronged) is "
        "NOT 'hot'. A patient can be furious at the employer while treating the listener warmly or "
        "neutrally — that is 'warm' or 'flat', never 'hot'. 'hot' requires hostility pointed AT THE "
        "LISTENER. Ask: is the patient being hostile TO ME, or complaining to me about someone else "
        "while treating me fine?\n"
        "Anchors: 'Don't you dare tell me it was structural — you sound just like them' -> hot. 'They "
        "were so unfair, but you get it, you're the only one who sees it' -> warm. 'They kept everyone "
        "else and let me go; it wasn't right' (no stance toward the listener) -> flat.\n"
