...
delivery — STANCE TOWARD THE INTERLOCUTOR (the person in THIS conversation), not toward the employer. 'hot' = hostility/escalation aimed AT THE INTERLOCUTOR: snaps at or dismisses their suggestions, attacks them, treats a reframe as betrayal. 'warm' = appreciative/cooperative/closeness-seeking toward the interlocutor, EVEN IF aggrieved about external events. 'flat' = cool/detached toward the interlocutor. CRUCIAL: anger/grievance about the EMPLOYER or absent third parties is engine (externalizing), NOT delivery; a turn can be grievance-heavy about the company AND warm toward the interlocutor -> label warm.
...
out = TPATH.with_name(TPATH.stem + ".reannotated_v3.json")
