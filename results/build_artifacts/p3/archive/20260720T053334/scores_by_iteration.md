# P3 — dimension pass-rates over 1 iteration(s)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 0 | 13m05s | 67% | 0% | False | 0% | 100% | 100% | 100% | 0% | 100% | 0/10 | ★ |

- Total elapsed: **13m05s** over 1 iteration(s).
- Best iteration: **iter 0** (mean 67%).
