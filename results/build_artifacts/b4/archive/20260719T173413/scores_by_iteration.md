# B4 — dimension pass-rates over 1 iteration(s)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 0 | 14m07s | 82% | 70% | False | 70% | 90% | 80% | 50% | 100% | 100% | 0/10 | ★ |

- Total elapsed: **14m07s** over 1 iteration(s).
- Best iteration: **iter 0** (mean 82%).
- **No convergence — this is best-of-N SAMPLING.** Never cleared the spread guard; blocked by: engine_direction, forthcomingness, disclosure_depth.
