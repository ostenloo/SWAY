# B2 — dimension pass-rates over 1 iteration(s)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 0 | 13m37s | 80% | 100% | False | 100% | 0% | 78% | 100% | 100% | 100% | 1/10 | ★ |

- Total elapsed: **13m37s** over 1 iteration(s).
- Best iteration: **iter 0** (mean 80%).
- **No convergence — this is best-of-N SAMPLING.** Never cleared the spread guard; blocked by: delivery, forthcomingness.
