# B5 — dimension pass-rates over 1 iteration(s)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 0 | 13m35s | 83% | 0% | False | 0% | 100% | 100% | 100% | 100% | 100% | 0/10 | ★ |

- Total elapsed: **13m35s** over 1 iteration(s).
- Best iteration: **iter 0** (mean 83%).
