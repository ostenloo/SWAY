# P2 — dimension pass-rates over 1 iteration(s)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 0 | 13m20s | 47% | 0% | False | 0% | 100% | 80% | 100% | 0% | 0% | 0/10 | ★ |

- Total elapsed: **13m20s** over 1 iteration(s).
- Best iteration: **iter 0** (mean 47%).
- **No convergence — this is best-of-N SAMPLING.** Never cleared the spread guard; blocked by: engine_direction, forthcomingness, comprehension, expression.
